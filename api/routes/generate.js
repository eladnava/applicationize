...
exports.getExtensionTitle = function (dom, host) {
    var pageTitle;
    ...
    switch (host) {
        ...
        default:
            ...
            pageTitle = dom('title').text().trim();
    }

    return pageTitle || host;
};

exports.getExtensionIcon = function (dom, host) {
    var icon;
    ...
    switch (host) {
        ...
        case knownHosts.facebookMessanger:
            ...
            break;
        default:
            icon = dom('link[rel="icon"], link[rel="shortcut icon"]').attr('href');
    }
